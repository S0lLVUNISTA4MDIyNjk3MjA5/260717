 ...
 *
 * NAMING NOTE (Checkpoint 2-C.1, AUDIT-2C-01): this file is deliberately named with an "_l32_"
 * infix, distinct from the pre-existing, unrelated
 * private_dictionary_p2a4_authorized_matching_diff_guard_selftest_checkpoint2c.js (HE-1
 * Remediation's OWN Checkpoint 2-C, RISK-FUZZY-01 - a same-named-but-unrelated earlier round). The
 * original L3-2 Checkpoint 2-C work incorrectly overwrote that historical file's contents instead
 * of creating a new one; Checkpoint 2-C.1 restored the historical file byte-exact from its
 * pre-L3-2-2-C content and moved this L3-2 content here instead. This file is the CURRENT L3-2
 * guard selftest; the historical checkpoint2c.js file is frozen evidence and is not expected to
 * pass against the current HEAD (see its own historical hunk-count assertions).
 *
 * Run: node private_dictionary_p2a4_authorized_matching_diff_guard_selftest_l32_checkpoint2c.js
 */
'use strict';
