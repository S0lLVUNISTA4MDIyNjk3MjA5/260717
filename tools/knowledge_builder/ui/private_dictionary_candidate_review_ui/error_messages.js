...
(function (root, factory) {
  ...
  const MESSAGES = {
    ...
    REVIEW_FILE_TOO_LARGE: '選択したレビューWorkbookが上限を超えています。読み込みは行っていません。',
    REVIEW_WORKBOOK_INVALID: 'レビューWorkbookの形式が不正なため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_SHEET_MISMATCH: 'レビューWorkbookのsheet構成が一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_HEADER_MISMATCH: 'レビューWorkbookの列構成が一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_SCHEMA_MISMATCH: 'レビューWorkbookのバージョンが現在の解析結果と一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_SOURCE_MISMATCH: 'レビューWorkbookの出典情報が現在の解析結果と一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_CANDIDATE_SET_MISMATCH: 'レビューWorkbookの候補構成が現在の解析結果と一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_ALIAS_SET_MISMATCH: 'レビューWorkbookのAlias構成が現在の解析結果と一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_CONFLICT_SET_MISMATCH: 'レビューWorkbookのConflict構成が現在の解析結果と一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_SCOPE_STATUS_MISMATCH: 'レビューWorkbookのscope/status情報が一致しないため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_ENUM_INVALID: 'レビューWorkbookに不正な判定値が含まれているため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
    REVIEW_SELECTED_CANDIDATE_INVALID: 'レビューWorkbookのConflict選択が不正なため、読み込みを中止しました。現在のレビュー内容は変更されていません。',
